...
select   
        ...
        non_hub_formula_range,
        count(distinct ref_order_id)/cast(count(distinct autopay_date) as double) as stack_ado,
        sum(opt2_fee)/cast(count(distinct autopay_date) as double) as avg_stacked_fee,
        sum(option2_non_extra)/cast(count(distinct autopay_date) as double) as base_fee_non_hub_formula ,
        sum(opt2_fee - option2_non_extra)/cast(count(distinct autopay_date) as double) as extra_fee_non_hub_formula
...
(select 
        ...
        case 
        when h.opt2_fee*total_order_in_group between 9000 and 10000 then '1. 9000 to 10000'
        when h.opt2_fee*total_order_in_group between 10000 and 11000 then '2. 10000 to 11000'
        when h.opt2_fee*total_order_in_group between 11000 and 12000 then '3. 11000 to 12000'
        when h.opt2_fee*total_order_in_group between 12000 and 13000 then '4. 12000 to 13000'
        when h.opt2_fee*total_order_in_group between 13000 and 14000 then '5. 13000 to 14000'
        when h.opt2_fee*total_order_in_group between 14000 and 15000 then '6. 14000 to 15000'
        when h.opt2_fee*total_order_in_group between 15000 and 16000 then '7. 15000 to 16000'
        when h.opt2_fee*total_order_in_group between 16000 and 17000 then '8. 16000 to 17000'
        when h.opt2_fee*total_order_in_group between 17000 and 18000 then '9. 17000 to 18000'
        when h.opt2_fee*total_order_in_group between 18000 and 19000 then '10. 18000 to 19000'
        when h.opt2_fee*total_order_in_group between 19000 and 20000 then '11. 19000 to 20000'
        when h.opt2_fee*total_order_in_group between 20000 and 21000 then '12. 20000 to 21000'
        when h.opt2_fee*total_order_in_group between 21000 and 22000 then '13. 21000 to 22000'
        when h.opt2_fee*total_order_in_group between 22000 and 23000 then '14. 22000 to 23000'
        when h.opt2_fee*total_order_in_group between 23000 and 24000 then '15. 23000 to 24000'
        when h.opt2_fee*total_order_in_group between 24000 and 25000 then '16. 24000 to 25000'
        when h.opt2_fee*total_order_in_group between 25000 and 26000 then '17. 25000 to 26000'
        when h.opt2_fee*total_order_in_group between 26000 and 27000 then '18. 26000 to 27000'
        when h.opt2_fee*total_order_in_group between 27000 and 28000 then '19. 27000 to 28000'
        when h.opt2_fee*total_order_in_group between 28000 and 29000 then '20. 28000 to 29000' 
        when h.opt2_fee*total_order_in_group > 29000 then '21. ++29000'
        else 'other_range' end as non_hub_formula_range
...
group by 1,2
-- and non_hub_formula_range = 'other_range'