...
SELECT
    ...
    ,distance_range
    ,is_bw
    ,case when peak_mode_name = 'Peak 3 Mode' then 1 else 0 end as is_peak3
...
LEFT JOIN
                ...
                )mode on mode.city_id = base1.city_id and mode.district_id = base1.district_id and base1.created_timestamp >= mode.start_time and base1.created_timestamp < mode.end_time 
)base2
...
and inflow_date between date'2022-09-06' and date'2022-09-12'
