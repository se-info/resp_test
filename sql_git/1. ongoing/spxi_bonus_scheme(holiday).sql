...
and date(a.delivered_timestamp) between date'2024-05-02' and date'2024-05-03'
and a.order_type = 6
)
,district_filter as 
(select 
...
(select 
        *,
        case 
        when total_day_qualified_district >= 2  and working_days >= 2 and total_qualified_online >= 2 and total_qualified_sla >= 2 
        and total_order >= 45 then 120000
...
where report_date between date'2024-05-02' and date'2024-05-03'
