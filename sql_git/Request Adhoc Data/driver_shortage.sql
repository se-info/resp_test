...
WHERE raw.created_date BETWEEN current_date - interval '7' day and current_date - interval '1' day
)
SELECT  
        created_date
       ,created_hour
       ,pick_city_name
       ,pick_district_name
       ,pick_district_name||CAST(created_date AS VARCHAR)||pick_city_name||CAST(created_hour AS VARCHAR) AS lookup_value
...
GROUP BY 1,2,3,4,5
ORDER BY 1,2 ASC
-- SELECT DISTINCT order_status FROM dev_vnfdbi_opsndrivers.phong_raw_order_checking