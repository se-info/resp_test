...
select 
        ...
        count(distinct case when pp_dr <= 0.3 then shipper_id else null end) as driver_impact_70pp,
        count(distinct case when pp_dr <= 0.1 then shipper_id else null end) as driver_impact_90pp,
        ...
        sum(case when pp_dr >= 0.3 then bonus_saving else null end) as bonus_add_on_70pp,
        sum(case when pp_dr >= 0.1 then bonus_saving else null end) as bonus_add_on_90pp
