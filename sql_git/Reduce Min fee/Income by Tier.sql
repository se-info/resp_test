...
SELECT
        ...
        ,(SUM(total_cost_opt1 + extra_12k5 + daily_bonus + other_income)/CAST(COUNT(shipper_id) AS DOUBLE)) AS income_opt1
        ,(SUM(total_cost_opt2 + extra_12k + daily_bonus + other_income)/CAST(COUNT(shipper_id) AS DOUBLE)) AS income_opt2
        ,(SUM(total_cost_opt3 + extra_12k + daily_bonus + other_income)/CAST(COUNT(shipper_id) AS DOUBLE)) AS income_opt3
        ,(SUM(total_cost_opt4 + extra_current + daily_bonus + other_income)/CAST(COUNT(shipper_id) AS DOUBLE)) AS income_opt4
