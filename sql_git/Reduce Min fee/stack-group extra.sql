...
AND DATE(FROM_UNIXTIME(dot.real_drop_time - 3600)) between date'2023-07-31' and date'2023-08-06' 
...
-- SELECT * FROM raw WHERE opt2 > opt1 AND group_id > 0
SELECT
        --  report_date
...
WHERE grass_date between date'2023-07-31' AND date'2023-08-06'
AND currency = 'VND'
) ex

WHERE 1 = 1 
AND is_hub != 'hub'
GROUP BY 1,ex.exchange_rate
