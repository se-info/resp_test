...
-- left join (select shipper_id,count(distinct ref_order_code) as total_order from raw where report_date between date'2023-01-26')

where raw.report_date between date'2023-01-22' and date'2023-01-27'
