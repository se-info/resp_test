...
(
    select 
           ...
           ,count(distinct case when hour_minute between 1200 and 2359 then ref_order_code else null end) as total_order_12_24
...
select 
        ...
        ,case when snp.total_order_12_24 >= 25 and (rp.completed_rate/cast(100 as double)) >= 90 then 99000 
              when snp.total_order_12_24 >= 15 and (rp.completed_rate/cast(100 as double)) >= 90 then 50000
