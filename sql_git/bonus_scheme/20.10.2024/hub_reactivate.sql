...
where 1 = 1 
and h.date_ between date'2024-10-18' and date'2024-10-20'
group by 1,2
)
...
(select 
        ...
        sm.city_name,
        case
        when total_ignore = 0 and total_deny = 0 and total_order between 16 and 24 then 40000
        when total_ignore = 0 and total_deny = 0 and total_order between 25 and 29 then 80000
        when total_ignore = 0 and total_deny = 0 and total_order >= 30 then 150000 
