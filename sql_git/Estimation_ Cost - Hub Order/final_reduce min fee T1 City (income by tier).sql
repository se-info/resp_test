...
SELECT 
        ...
        ,SUM(cnt_hub_order)/CAST(COUNT(DISTINCT report_date) AS DOUBLE) AS cnt_hub_order
        ,SUM(cnt_non_hub_order)/CAST(COUNT(DISTINCT report_date) AS DOUBLE) AS cnt_non_hub_order
