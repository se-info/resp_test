    ...
    FROM
        ...
        SELECT
            ...
            FROM
                ...
                WHERE 1=1
                AND base.report_date BETWEEN DATE'2021-02-11' AND DATE'2021-02-18'
...
WHERE snp.current_driver_tier != 'Hub'
...
FROM
    ...
    AND date(from_unixtime(create_time - 3600)) between date'2021-02-11' and date'2021-02-18'
    GROUP BY 1
    )
)i
INNER JOIN ranking r ON i.shipper_id = r.shipper_id
LEFT JOIN shopeefood.foody_mart__profile_shipper_master sm ON r.shipper_id = sm.shipper_id AND TRY_CAST(sm.grass_date AS DATE) = date'2021-02-18'
