...
select
        ...
        ,sum(a.total_order_delivery)*1.0000/count(distinct a.report_date) as total_order_delivery
        ,sum(a.total_order_ship)*1.0000/count(distinct a.report_date) as total_order_ship
        ,sum(a.total_late)*1.0000/sum(a.total_order_delivery) as late_rate_delivery
        ,sum(a.total_late_ship)*1.0000/sum(a.total_order_ship) as late_rate_ship        
...
order by date_ desc
)hub on hc.date_ = reg.date_ and hc.shipper_id = reg.uid
