...
,case when base1.create_date = date('2022-03-08') then cast(base1.create_date as varchar)
      when base1.create_date = date('2021-12-12') then cast(base1.create_date as varchar)
      when base1.create_date = date('2022-04-04') then cast(base1.create_date as varchar)
      when base1.create_date = date('2021-11-11') then cast(base1.create_date as varchar)
      else 'W13' end as date_group
