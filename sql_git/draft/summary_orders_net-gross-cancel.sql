...
SELECT
    ...
    ,count(distinct if(is_no_driver_assign = 1, uid, null)) as cnt_cancel_no_driver
    ,count(distinct uid) as total_submit
    ,count(distinct case when order_status = 'Delivered' then uid else null end) as total_net
...
SELECT
      d.*
FROM daily d
where d.date_ between date'2021-04-14' and date'2021-05-05'
