...
and date(from_unixtime(a.real_drop_time - 3600)) between current_date - interval '1' day and current_date + interval '1' day
)
...
(SELECT '1. Real-time' as period 
        ,uid
        ,city_name
        ,case when total_order >= 15 and total_order < 25 and city_name in ('2. HCM','3. HN') and date_ = date('2021-12-12') then 60000
              when total_order >= 25 and total_order < 35 and city_name in ('2. HCM','3. HN') and date_ = date('2021-12-12') then 120000
              when total_order >= 35 and city_name in ('2. HCM','3. HN') and date_ = date('2021-12-12') then 180000
