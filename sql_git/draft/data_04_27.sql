SELECT base1.inflow_date
-- ,base1.source
-- ,base1.order_source
,base1.source_v2
,base1.city_group
,base1.inflow_hour
,count(distinct base1.uid) as net_orders
...
,cast(count(distinct case when peak_mode_name = 'Peak 1 Mode' then base1.uid else null end) as double) as net_peak1_orders
,cast(count(distinct case when peak_mode_name = 'Peak 2 Mode' then base1.uid else null end) as double) as net_peak2_orders
,cast(count(distinct case when peak_mode_name = 'Peak 3 Mode' then base1.uid else null end) as double) as net_peak3_orders
,cast(count(distinct case when peak_mode_name = 'Normal' then base1.uid else null end) as double) as net_normal_orders
,cast(count(distinct case when distance_range = '1. 0-3km' then base1.uid else null end) as double) as net_under_3km_orders
,cast(count(distinct case when distance_range = '2. 3km+' then base1.uid else null end) as double) as net_above_3km_orders
,cast(sum(case when distance_range = '1. 0-3km' then base1.distance else null end) as double) as under_3km_distance
,cast(sum(case when distance_range = '2. 3km+' then base1.distance else null end) as double) as above_3km_distance
,count(distinct case when is_hub_order = 0 then base1.uid else null end) total_non_hub_order
,count(distinct case when is_hub_order = 1 then base1.uid else null end) total_hub_order
...
,cast(count(distinct case when distance_range = '1. 0-3km' and is_hub_order = 0 then base1.uid else null end) as double) as net_non_hub_under_3km_orders
,cast(count(distinct case when distance_range = '2. 3km+' and is_hub_order = 0 then base1.uid else null end) as double) as net_non_hub_above_3km_distance
...
where (date(inflow_timestamp) between date('2022-04-27') and date '2022-04-27')
