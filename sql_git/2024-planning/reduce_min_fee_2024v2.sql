...
(select 
        ...
        when oi.slot_id is null and oi.group_id > 0 then ogi.group_fee_opt1 + extra_fee_allocate end as fee_opt1,

        case 
        when oi.slot_id > 0 then oi.hub_opt2
        when oi.slot_id is null and oi.group_id = 0 then oi.non_hub_opt2
        when oi.slot_id is null and oi.group_id > 0 then ogi.group_fee_opt2 + extra_fee_allocate end as fee_opt2,

        case 
        when oi.slot_id > 0 then oi.hub_opt3
        when oi.slot_id is null and oi.group_id = 0 then oi.non_hub_opt3_4
        when oi.slot_id is null and oi.group_id > 0 then ogi.group_fee_opt3_4 + extra_fee_allocate end as fee_opt3,

        case 
        when oi.slot_id > 0 then oi.hub_opt4
        when oi.slot_id is null and oi.group_id = 0 then oi.non_hub_opt3_4
        when oi.slot_id is null and oi.group_id > 0 then ogi.group_fee_opt3_4 + extra_fee_allocate end as fee_opt4
