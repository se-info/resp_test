...
SELECT
    ...
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by Driver' THEN order_code ELSE NULL END) cancel_by_driver,
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by Platform' THEN order_code ELSE NULL END) cancel_by_platform, 
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by User' THEN order_code ELSE NULL END) cancel_by_user,
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by Shopee' THEN order_code ELSE NULL END) cancel_by_shopee, 
    1.00000*COUNT(DISTINCT CASE WHEN order_type not in ('Delivered','Cancel by Driver','Cancel by Platform','Cancel by User','Cancel by Shopee') THEN order_code ELSE NULL END) other_status     
...
SELECT
    ...
    'Time' as grp,
    timeframe grp_item, 
    -- 1.00000*COUNT(DISTINCT CASE WHEN order_status = 'Delivered' THEN order_code ELSE NULL END) g2n,
    -- 1.00000*COUNT(DISTINCT CASE WHEN order_status = 'Pickup Failed'  THEN order_code ELSE NULL END) cancel_by_driver,
    -- 1.00000*(COUNT(DISTINCT CASE WHEN order_status IN ('Cancelled','Assigning Timeout') THEN order_code ELSE NULL END) - COUNT(DISTINCT CASE WHEN (lower(cancel_by) = 'user_cancelled' OR lower(cancel_type) = 'user_cancelled' ) THEN order_code ELSE NULL END)) cancel_by_platform, 
    -- 1.00000*COUNT(DISTINCT CASE WHEN lower(cancel_type) = 'user_cancelled' OR lower(cancel_by) = 'user_cancelled' THEN order_code ELSE NULL END) user_cancel 
    1.00000*COUNT(DISTINCT CASE WHEN order_type not in ('Cancel by Driver','Cancel by Platform','Cancel by User','Cancel by Shopee') THEN order_code ELSE NULL END)/COUNT(DISTINCT order_code) g2n,
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by Driver' THEN order_code ELSE NULL END) cancel_by_driver,
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by Platform' THEN order_code ELSE NULL END) cancel_by_platform, 
    1.00000*COUNT(DISTINCT CASE WHEN order_type = 'Cancel by User' THEN order_code ELSE NULL END) cancel_by_user,
