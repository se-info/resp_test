...
(SELECT   
        ...
        ,city_group
        ,reg.total_reg
        ,sum(case when (a.report_date = date'2022-06-05' or a.report_date = date'2022-05-15') then a.is_qualified_kpi else null end) as kpi_sun
        ,sum(case when (a.report_date = date'2022-06-05' or a.report_date = date'2022-05-15') then a.total_order else null end) as is_work_sun
...
where (a.report_date between date'2022-05-09' and date'2022-05-15' or a.report_date between date'2022-05-30' and date'2022-06-05')
