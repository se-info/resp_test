-- DROP TABLE IF EXISTS dev_vnfdbi_opsndrivers.phong_lead_time_by_hour;
-- CREATE TABLE IF NOT EXISTS dev_vnfdbi_opsndrivers.phong_lead_time_by_hour AS
...
FROM
        ...
        FROM
                    ...
                    and date(case when dot.is_asap = 0 then fa.first_auto_assign_timestamp else from_unixtime(dot.submitted_time- 60*60) end) between current_date - interval '30' day and current_date - interval '1' day
...
and created_date between current_date - interval '45' day and current_date - interval '1' day
